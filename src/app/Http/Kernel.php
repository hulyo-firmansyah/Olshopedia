...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'b.guest' => \App\Http\Middleware\BelakangIfRedirectAuth::class,
        'b.auth' => \App\Http\Middleware\BelakangAuth::class,
        'b.locale' => \App\Http\Middleware\BelakangLocale::class,
