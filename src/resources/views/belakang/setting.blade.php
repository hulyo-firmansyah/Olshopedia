        ...
        <div class="col-md-10">
            <div class="nav-tabs-horizontal nav-tabs-inverse nav-tabs-animate animation-slide-top" style='animation-delay:80ms'>
                <ul class="nav nav-tabs nav-tabs-solid" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-toggle="tab" href="#supplierSide" aria-controls="supplierSide" id='supplierSideTombol'
                            role="tab" aria-expanded="true">
                            <i class="icon fa-user"></i>Supplier
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content">
                    ...
                    <!-- -- Pengaturan supplier -- -->
                    <div class="tab-pane animation-slide-top" id="supplierSide" role="tabpanel">
                        <div class="row justify-content-end">
                            <div class="col-md-6">
                                <h4 class="example-title">Pengaturan Supplier</h4>
                            </div>
                            <div class="col-md-4">
                                <button class="btn btn-success" data-target="#tambahSupplier" data-toggle="modal"
                                    type="button"><i class='fa fa-plus'></i> Tambah Supplier</button>
                            </div>
                        </div>
                        <hr>
                        <div class="row justify-content-center">
                ...
                <form id="formTambahSupplier">
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="email" class="form-control" name="emailSupplier" placeholder="Email" id="emailSupplier">
                            <small id="error_emailSupplier" style='color:#f2353c;display:none;'>Masukkan Email!</small>
                        </div>
                    </div>
                    <div class='row'>
                        <div class="col-lg-4 form-group">
                            <label for="">Username</label>
                            <input type="text" class="form-control" name="usernameSupplier" placeholder="Username" id="usernameSupplier">
                            <small id="error_username" style="color:#f2353c; display: none;">Masukkan Username Dengan Benar!</small>
                        </div>
                        <div class="col-lg-4 form-group">
                            <label for="">Password</label>
                            <div class="input-search">
                                <button type="button" style="height:40px;cursor:pointer;" class="input-search-btn" id='btnEye_supplier' tabindex='-1'><i class="icon md-eye-off" aria-hidden="true"></i></button>
                                <input type="text" name="passwordSupplier" class="form-control" placeholder="Password" value="{{$pass}}" id="passwordSupplier" autocomplete="on" style='border-radius:unset'>
                                <small id="error_passwordSupplier" style='color:#f2353c;display:none;'>Password tidak sama!</small>
                            </div>
                            <!-- <div class="input-group">
                                <input type="text" class="form-control" name="passwordSupplier" value="{{$pass}}" id="passwordSupplier" readonly>
                                <div class=" input-group-append">
                                    <button type='button' onClick='copyToClipboard($("#passwordSupplier"))' style='cursor:pointer' class='input-group-text'>Copy</button>
                                </div>
                            </div> -->
                        </div>
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" class="form-control" name="no_telpSupplier" placeholder="No Telepon"
                                id="no_telpSupplier">
                            <small id="error_no_telpSupplier" style='color:#f2353c;display:none;'>Masukkan No Telepon Dengan Benar!</small>
                        </div>
                    </div>
                    <div class='row'>
...
<div class="modal fade modal-fade-in-scale-up" id="editSupplier" aria-hidden="true" aria-labelledby="exampleModalTitle"
    ...
    <div class="modal-dialog modal-simple modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formEditSupplier">
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group">
                            <label for="">Email</label>
                            <input type="email" class="form-control" name="edit_emailSupplier" placeholder="Email" id="edit_emailSupplier">
                            <small id="error_edit_emailSupplier" style='color:#f2353c;display:none;'>Masukkan Email!</small>
                        </div>
                    </div>
                    <div class='row'>
                        <div class="col-lg-6 form-group">
                            <label for="">Username</label>
                            <input type="text" class="form-control" name="edit_usernameSupplier" placeholder="Username" id="edit_usernameSupplier">
                            <small id="error_edit_username" style="color:#f2353c; display: none;">Masukkan Username Dengan Benar!</small>
                        </div>
                        <div class="col-lg-6 form-group">
                            <label>No Telepon</label>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-warning" name='btnEditSupplier'>Update</button>
                <button class="btn btn-default" data-dismiss="modal">Batal</button>
            </div>
        </div>
    </div>
...
var tabelDataOrderSource, tabelDataPayment, tabelDataSupplier, tableDataUser, tableFilterOrder;
...
$(document).ready(function() {
    ...
    $('#btnEye_supplier').click(function(){
        if($('#passwordSupplier').attr('type') == 'password'){
            $('#passwordSupplier').attr('type', 'text');
            $('#btnEye_supplier').children().attr('class', 'icon md-eye-off');
        } else if($('#passwordSupplier').attr('type') == 'text'){
            $('#passwordSupplier').attr('type', 'password');
            $('#btnEye_supplier').children().attr('class', 'icon md-eye');
        }
    });
    ...
    $('#supplierSideTombol').on('click', function(){
        //Get data supplier table
        tabelDataSupplier = $('#tableSupplier').DataTable({
            ajax: {
                type: 'get',
                url: "{{ route('b.setting-getSupplierData') }}",
            },
            "columnDefs": [{
                "searchable": false,
                "orderable": false,
    ...
    $("button[name=btnTambahSupplier]").on('click', function() {
        ...
        var usernameSupplier = $('#usernameSupplier').val();
        var emailSupplier = $('#emailSupplier').val();
        var passSupplier = $('#passwordSupplier').val();
        ...
        if (usernameSupplier == "") {
            $('#usernameSupplier').addClass('is-invalid animation-shake');
            $('small#error_username').attr('style', 'color:#f2353c;');
            $('small#error_username').show();
            error++;
        }
        if (emailSupplier == "") {
            $('#emailSupplier').addClass('is-invalid animation-shake');
            $('small#error_emailSupplier').attr('style', 'color:#f2353c;');
            $('small#error_emailSupplier').text('Masukkan Email!');
            $('small#error_emailSupplier').show();
            error++;
        }
        if (passSupplier == "") {
            $('#passwordSupplier').addClass('is-invalid animation-shake');
            $('small#error_passwordSupplier').attr('style', 'color:#f2353c;');
            $('small#error_passwordSupplier').text('Masukkan Password!');
            $('small#error_passwordSupplier').show();
            error++;
        }
        if (emailSupplier != "" && !cekEmail(emailSupplier)) {
            $('#emailSupplier').addClass('is-invalid animation-shake');
            $('small#error_emailSupplier').attr('style', 'color:#f2353c;');
            $('small#error_emailSupplier').text('Masukkan Email yang valid!');
            $('small#error_emailSupplier').show();
            error++;
        }
        if (no_telpSupplier == "") {
            $('#no_telpSupplier').addClass('is-invalid animation-shake');
            $('small#error_no_telpSupplier').attr('style', 'color:#f2353c;');
            $('small#error_no_telpSupplier').show();
            error++;
        }
        if (kode_posSupplier == "") {
    ...
    $('#passwordSupplier').on('input', function(){
        if($('small#error_passwordSupplier').is(':visible')){
            $('small#error_passwordSupplier').hide();
            $('#passwordSupplier').removeClass('is-invalid animation-shake');
        }
    });

    $('#usernameSupplier').on('input', function(){
        if($('small#error_username').is(':visible')){
            $('small#error_username').hide();
            $('#usernameSupplier').removeClass('is-invalid animation-shake');
        }
    });

    $('#emailSupplier').on('input', function(){
        if($('small#error_emailSupplier').is(':visible')){
            $('small#error_emailSupplier').hide();
            $('#emailSupplier').removeClass('is-invalid animation-shake');
        }
    });
    ...
    $("button[name=btnEditSupplier]").on('click', function() {
        ...
        var edit_usernameSupplier = $('#edit_usernameSupplier').val();
        var edit_emailSupplier = $('#edit_emailSupplier').val();
        ...
        if (edit_usernameSupplier == "") {
            $('#edit_usernameSupplier').addClass('is-invalid animation-shake');
            $('small#error_edit_username').attr('style', 'color:#f2353c;');
            $('small#error_edit_username').show();
            error++;
        }
        if (edit_emailSupplier == "") {
            $('#edit_emailSupplier').addClass('is-invalid animation-shake');
            $('small#error_edit_emailSupplier').attr('style', 'color:#f2353c;');
            $('small#error_edit_emailSupplier').show();
            error++;
        }
        if (edit_no_telpSupplier == "") {
            $('#edit_no_telpSupplier').addClass('is-invalid animation-shake');
            $('small#error_edit_no_telpSupplier').attr('style', 'color:#f2353c;');
            $('small#error_edit_no_telpSupplier').show();
            error++;
        }
    ...
    $('#edit_usernameSupplier').on('input', function(){
        if($('small#error_edit_username').is(':visible')){
            $('small#error_edit_username').hide();
            $('#edit_usernameSupplier').removeClass('is-invalid animation-shake');
        }
    });

    $('#edit_emailSupplier').on('input', function(){
        if($('small#error_edit_emailSupplier').is(':visible')){
            $('small#error_edit_emailSupplier').hide();
            $('#edit_emailSupplier').removeClass('is-invalid animation-shake');
        }
    });

    $('#edit_no_telpSupplier').on('input', function(){
        if($('small#error_edit_no_telpSupplier').is(':visible')){
            $('small#error_edit_no_telpSupplier').hide();
            $('#edit_no_telpSupplier').removeClass('is-invalid animation-shake');
        }
    });
...
(function(world) {
    ...
    world.fn.editSupplier = function() {
        ...
        $.ajax({
            ...
            $('#edit_usernameSupplier').val(hasil.username);
            $('#edit_emailSupplier').val(hasil.email);
        ...
        swal({
            ...
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    data: {
                        userId: id,
                        dd: "{{ $key['h_supplier']['dd'] }}",
                        tt: "{{ $key['h_supplier']['tt'] }}"
                    },
                    success: function(data) {
                        hasil = data;
                    },
