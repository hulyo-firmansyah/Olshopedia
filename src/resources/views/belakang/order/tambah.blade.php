...
<div class="page-header page-header-bordered">
    <h1 class="page-title font-size-26 font-weight-100">Tambah Order</h1>
                ...
                <div class="panel panel-bordered panel-primary animation-slide-left" style='animation-delay:100ms;'>
                    ...
                    <div class="panel-body">
                        ...
                        <div class='form-group'>
                            ...
                            <textarea class='form-control' id="catatanOrder"></textarea>
                        </div>
                        <div class='form-group'>
                            <input type="checkbox" name='cNote' id='icNote' />
                ...
                <div class='row'>
                    <div class='col-md-6'>
                        <button class="btn btn-success btn-block animation-slide-bottom mt-10"
                            ...
                            onClick='simpan_produk("simpan")'>Simpan
                            Order</button>
                    </div>
                    <div class='col-md-6'>
                        <button class="btn btn-success btn-outline btn-block animation-slide-bottom mt-10"
                            style='animation-delay:1000ms;' type="button" id="btnsimpan_produk_tambah" onClick='simpan_produk("tambah")'>Simpan
                            dan
...
var simpan_produk = function(tipeKirim = "simpan") {
    var data = {};
    var error = [];
...
$(document).ready(() => {
    ...
    $('#idDariKirim').on('change', function(e, ui) {
        if($(this).hasClass("animation-shake")){
            $(this).removeClass("animation-shake");
            $(this).attr("style", "");
        }
        // pilihDari = this.value;
    });
