        ...
        <div class='col-md-6'>
            <div class="page-header-actions">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Filter Order</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="page-content">
    ...
    <ul class="row justify-content-center" style='list-style-type: none;'>
        <li class="p-5 animation-slide-top animation-delay-100">
            <a class="btn btn-round p-15 btnFilterClick {{ $btnFilterCSS['f_semua'] }}" data-id='f_semua' href="javascript:void(0)">
                <i class="icon wb-search" aria-hidden="true"></i>
                Semua Order
            </a>
        </li>
        <li class="p-5 animation-slide-top animation-delay-200">
            <a class="btn btn-round p-15 btnFilterClick {{ $btnFilterCSS['f_belum_bayar'] }}" data-id='f_belum_bayar' href="javascript:void(0)">
                <i class="icon wb-search" aria-hidden="true"></i>
                Belum Bayar
            </a>
        </li>
        <li class="p-5 animation-slide-top animation-delay-300">
            <a class="btn btn-round p-15 btnFilterClick {{ $btnFilterCSS['f_belum_lunas'] }}" data-id='f_belum_lunas' href="javascript:void(0)">
                <i class="icon wb-search" aria-hidden="true"></i>
                Belum Lunas
            </a>
        </li>
        <li class="p-5 animation-slide-top animation-delay-400">
            <a class="btn btn-round p-15 btnFilterClick {{ $btnFilterCSS['f_belum_proses'] }}" data-id='f_belum_proses' href="javascript:void(0)">
                <i class="icon wb-search" aria-hidden="true"></i>
                Belum Diproses
            </a>
        </li>
        <li class="p-5 animation-slide-top animation-delay-500">
            <a class="btn btn-round p-15 btnFilterClick {{ $btnFilterCSS['f_belum_resi'] }}" data-id='f_belum_resi' href="javascript:void(0)">
                <i class="icon wb-search" aria-hidden="true"></i>
                Belum Ada Resi
            </a>
        </li>
        <li class="p-5 animation-slide-top animation-delay-600">
            <a class="btn btn-round p-15 btnFilterClick {{ $btnFilterCSS['f_dalam_proses'] }}" data-id='f_dalam_proses' href="javascript:void(0)">
                <i class="icon wb-search" aria-hidden="true"></i>
                Pengiriman Dalam Proses
            </a>
        </li>
        <li class="p-5 animation-slide-top animation-delay-700">
            <a class="btn btn-round p-15 btnFilterClick {{ $btnFilterCSS['f_kirim_berhasil'] }}" data-id='f_kirim_berhasil' href="javascript:void(0)">
                <i class="icon wb-search" aria-hidden="true"></i>
                Pengiriman Berhasil
            </a>
        </li>
                ...
                <div class="form-group animation-slide-right selectBug" style='animation-delay:200ms'>
                    ...
                    <div class="dropdown btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="exampleColorDropdown1" role="menu">
                            <a class="dropdown-item" href="{{ $excel_tgl['xlsx'] }}"><i class='wb-download'></i> Download Excel File (.xlsx)</a>
                            <a class="dropdown-item" href="{{ $excel_tgl['xls'] }}"><i class='wb-download'></i> Download Excel File (.xls)</a>
                            <a class="dropdown-item" href="{{ $excel_tgl['csv'] }}"><i class='wb-download'></i> Download Excel File (.csv)</a>
                        </div>
                    </div>
                    @endif
                </div>
        ...
        <div class="filter-box mb-20 animation-fade" style='animation-delay:200ms'>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-md-3 form-group'>
                            ...
                            <select class='form-control' id='filter-bayar' name='f_bayar'>
                                <option value='0' @if(request()->f_bayar == '0') selected @endif>Semua</option>
                                <option value='belum' @if(request()->f_bayar == 'belum') selected @endif>Belum Bayar</option>
                                <option value='cicil' @if(request()->f_bayar == 'cicil') selected @endif>Cicilan</option>
                                <option value='lunas' @if(request()->f_bayar == 'lunas') selected @endif>Lunas</option>
                            </select>
                        </div>
                        <div class='col-md-3 form-group'>
                            <label>Pengiriman</label>
                            <select class='form-control' id='filter-kirim' name='f_kirim'>
                                <option value='0' @if(request()->f_kirim == '0') selected @endif>Semua</option>
                                <option value='belum_proses' @if(request()->f_kirim == 'belum_proses') selected @endif>Belum Diproses</option>
                                <option value='belum_resi' @if(request()->f_kirim == 'belum_resi') selected @endif>Belum Ada Resi</option>
                                <option value='dalam_kirim' @if(request()->f_kirim == 'dalam_kirim') selected @endif>Dalam Pengiriman</option>
                                <option value='sudah_tujuan' @if(request()->f_kirim == 'sudah_tujuan') selected @endif>Sudah Sampai Tujuan</option>
                            </select>
                        </div>
                        <div class='col-md-3 form-group'>
                    ...
                    <div class='row'>
                        <div class='col-md-3 form-group'>
                            ...
                            <select class='form-control' id='filter-kurir' name='f_kurir'>
                                <option value='0' @if(request()->f_kurir == '0') selected @endif>Semua</option>
                                <option value='input'  @if(request()->f_kurir == 'input') selected @endif>Input Manual</option>
                                <option value='toko'  @if(request()->f_kurir == 'toko') selected @endif>Ambil Di Toko</option>
                                <option value='jne'  @if(request()->f_kurir == 'jne') selected @endif>Jalur Nugraha Ekakurir (JNE)</option>
                                <option value='pos'  @if(request()->f_kurir == 'pos') selected @endif>POS Indonesia (POS)</option>
                                <option value='tiki'  @if(request()->f_kurir == 'tiki') selected @endif>Citra Van Titipan Kilat (TIKI)</option>
                                <option value='pcp'  @if(request()->f_kurir == 'pcp') selected @endif>Priority Cargo and Package (PCP)</option>
                                <option value='esl'  @if(request()->f_kurir == 'esl') selected @endif>Eka Sari Lorena (ESL)</option>
                                <option value='rpx'  @if(request()->f_kurir == 'rpx') selected @endif>RPX Holding (RPX)</option>
                                <option value='pandu'  @if(request()->f_kurir == 'pandu') selected @endif>Pandu Logistics (PANDU)</option>
                                <option value='wahana'  @if(request()->f_kurir == 'wahana') selected @endif>Wahana Prestasi Logistik (WAHANA)</option>
                                <option value='sicepat'  @if(request()->f_kurir == 'sicepat') selected @endif>SiCepat Express (SICEPAT)</option>
                                <option value='jnt'  @if(request()->f_kurir == 'jnt') selected @endif>J&T Express (J&T)</option>
                                <option value='pahala'  @if(request()->f_kurir == 'pahala') selected @endif>Pahala Kencana Express (PAHALA)</option>
                                <option value='sap'  @if(request()->f_kurir == 'sap') selected @endif>SAP Express (SAP)</option>
                                <option value='jet'  @if(request()->f_kurir == 'jet') selected @endif>JET Express (JET)</option>
                                <option value='slis'  @if(request()->f_kurir == 'slis') selected @endif>Solusi Ekspres (SLIS)</option>
                                <option value='dse'  @if(request()->f_kurir == 'dse') selected @endif>21 Express (DSE)</option>
                                <option value='first'  @if(request()->f_kurir == 'first') selected @endif>First Logistics (FIRST)</option>
                                <option value='ncs'  @if(request()->f_kurir == 'ncs') selected @endif>Nusantara Card Semesta (NCS)</option>
                                <option value='star'  @if(request()->f_kurir == 'star') selected @endif>Star Cargo (STAR)</option>
                                <option value='lion'  @if(request()->f_kurir == 'lion') selected @endif>Lion Parcel (LION)</option>
                                <option value='ninja'  @if(request()->f_kurir == 'ninja') selected @endif>Ninja Xpress (NINJA)</option>
                                <option value='idl'  @if(request()->f_kurir == 'idl') selected @endif>IDL Cargo (IDL)</option>
                                <option value='rex'  @if(request()->f_kurir == 'rex') selected @endif>Royal Express Indonesia (REX)</option>
                                <option value='indah'  @if(request()->f_kurir == 'indah') selected @endif>Indah Logistic (INDAH)</option>
                                <option value='cahaya'  @if(request()->f_kurir == 'cahaya') selected @endif>Cahaya Ekspress Logistik (CAHAYA)</option>
                            </select>
                        </div>
                        @if($order_source['cek'] == 'on')
                        @php
                            if(isset(request()->f_orderSource)){
                                $orderSourceSrc = request()->f_orderSource;
                                //echo "asdasdasdasd";
                            } else {
                                $orderSourceSrc = '0';
                                //echo "kocakocakoca";
                        ...
                        <div class='col-md-5 form-group'>
                            <div class='form-group'>
                                ...
                                <select class='form-control' id='filter-orderSource' name='f_orderSource'>
                                    <option value='0' @if($orderSourceSrc == '0') selected @endif>Semua</option>
                                    @foreach($order_source['data'] as $os)
                                        <option value='{{ $os->id_order_source }}' @if($orderSourceSrc == $os->id_order_source) selected @endif>{{ $os->kategori }} - {{ $os->keterangan }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class='col-md-3 form-group'>
                            ...
                            <div class="btn-group" data-toggle="buttons" role="group">
                                <label class="btn btn-outline btn-info @if(request()->f_print == '0') active @endif">
                                    <input type="radio"  name='f_print' class='hidden' autocomplete="off" value="0"
                                        checked>
                                    <!-- <i class="icon wb-check text-active" aria-hidden="true"></i>  -->
                                    Semua
                                </label>
                                <label class="btn btn-outline btn-info @if(request()->f_print == 'print') active @endif">
                                    <input type="radio" name='f_print' class='hidden' autocomplete="off" value="print">
                                    <!-- <i class="icon wb-check text-active" aria-hidden="true"></i>  -->
                                    Printed
                                </label>
                                <label class="btn btn-outline btn-info @if(request()->f_print == 'belum_print') active @endif">
                ...
                <div class='col-md-4' style='border-left:1px solid #ddd'>
                    <div class='row'>
                        <div class='col-md-12 form-group'>
                            ...
                            <div class="btn-group" data-toggle="buttons" role="group">
                                <label class="btn btn-outline btn-info @if(request()->f_tglTipe == 'bayar') active @endif">
                                    <input type="radio" name='f_tglTipe' class='hidden' autocomplete="off" value="bayar"
                                        checked>
                                    <!-- <i class="icon wb-check text-active" aria-hidden="true"></i>  -->
                                    Bayar
                                </label>
                                <label class="btn btn-outline btn-info @if(request()->f_tglTipe == 'order') active @endif">
                    ...
                    <div class='row'>
                        <div class='col-md-12 form-group'>
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id='datepickerDari' name='f_tglDari' autocomplete='off' value="{{ request()->f_tglDari }}">
                                <div class="input-group-addon">Sampai</div>
                                <input type="text" class="form-control" id="datepickerSampai" name='f_tglSampai'autocomplete='off' value="{{ request()->f_tglSampai }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class='row'>
                <div class='col-md-12'>
                    ...
                    @if($cekIdFilter["cek"])
                        <button type='button' class='btn btn-danger' id='btnHapusFilter' data-ff="{{ $cekIdFilter['id'] }}" data-dd="{{ $cekIdFilter['honey'] }}">Hapus Filter</button>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class='row mb-20'>
            <div class='col-md-12 animation-slide-left' style='font-size:20px;animation-delay:100ms'>
...
$(document).ready(function() {
    ...
    $("#filterMod").on("hidden.bs.modal", function(){
    ...
    $("#btnHapusFilter").on("click", function(){
        ...
        form.append("<input type='text' name='tipeKirim' value='filter_hapus'>");
        form.append("<input type='text' name='ff' value='"+$(this).data("ff")+"'>");
        form.append("<input type='text' name='dd' value='"+$(this).data("dd")+"'>");
        form.append('@csrf');
        $('body').append(form);
        form.submit();
    });
