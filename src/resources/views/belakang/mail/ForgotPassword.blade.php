                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <h1>@lang('mail-forgotpass.header')</h1>
                                        <p>@lang('mail-forgotpass.header-note')</p>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td>
                                                                            <a href="{{ $link }}" class="button button-primary" target="_blank">@lang('mail-forgotpass.btn-reset')</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <p>@lang('mail-forgotpass.footer-note')</b> 
                                        {{ $link }}

                                        <br><br>@lang('mail-forgotpass.salam')
                                    </td>
                                </tr>   
                            </table>
                        </td>
