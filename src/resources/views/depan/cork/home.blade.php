...
<div class="row layout-top-spacing">
    <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
        <div class="widget-content-area br-4">
            <div class="widget-one">
                ...
                <p class="">With CORK starter kit, you can begin your work without any hassle. The
                    starter page is highly optimized which gives you freedom to start with minimal code
                    and add only the desired components and plugins required for your project.</p>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
        <div class="card b-l-card-1 h-100"
            ...
            <img class="card-img-top" src="{{ asset('template_depan/cork/assets/img/400x300.jpg') }}"
                alt="Card image cap">
            <div class="card-body">
                    ...
                    <table class="table table-bordered mb-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>15/08/2018</td>
                                <td>555</td>
                                <td class="text-center"><span class="badge badge-info">Pending</span>
                                </td>
                                <td class="text-center">
                                    <div class="dropdown custom-dropdown">
                            ...
                            <tr>
                                ...
                                <td>16/08/2018</td>
                                <td>300</td>
                                <td class="text-center"><span class="badge badge-dark">Deleted</span>
                                </td>
                                <td class="text-center">
